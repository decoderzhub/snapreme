    ...
    <main>
      <section id="about" className="relative py-20 md:py-28 bg-gradient-to-b from-blue-50/60 to-transparent overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full text-sm font-semibold mb-6 shadow-lg animate-pulse">
            <Rocket className="w-4 h-4" />
            <span>Launching January 1st, 2026</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            ...
            >
              {user ? 'Go to Network' : 'Join the Network'}
            </Link>
            {!user && (
              <Link
                to="/login"
